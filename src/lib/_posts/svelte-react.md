...
category: javaScript
titleImage: /been-blog/postIcon/svelte-icon.webp
---
...
<img src="/been-blog/blog/javaScript/svelte.png" width="100%" alt="post image"/>
<img src="/been-blog/blog/javaScript/svelte(1).png" width="100%" alt="post image"/>
...
그러나 리액트에서는 JS에 대한 XML과 유사한 **JSX**를 배워야하지만, 스벨트는 더 쉬운 구문을 사용해 이해하기 쉬운 **자체 템플릿 언어**를 가지고 있.
